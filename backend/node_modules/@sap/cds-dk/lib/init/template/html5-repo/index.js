    ...
    async combine() {
        ...
        if (addMta || affected && hasMta) {
            ...
            await merge(__dirname, 'files/mta.yaml.hbs').into('mta.yaml', {
                with: project,
                additions: [srvModule, appDeployer, html5RepoHost, ...appModules],
                relationships
            })
        }
