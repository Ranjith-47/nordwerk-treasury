...
class Export extends Minify {
  ...
  async output (minified,o) {
    ...
    if (o.for === 'mvn') {
      // Maven task moves files from the default behaviour to Maven specific locations,
      // so we need to await this separately
      await mvn.add('cds_export', { 'module-name': o.to })
    }
    console.log()
  }
